	...
	for deg in range(num_degrees):
		for data_rep in range(num_data_replicates):
			for saa_rep in range(num_saa_replicates):
				SAA_file = open("../output/case" + str(1+std) + "_saa/mod_1/deg_" + str(deg+1) + "/rep_" + str(data_rep+1) + "/saa_" + str(saa_rep+1) + "/saa_obj.txt", "r")
...
for std in range(num_stdevs):
	for samp_size in range(num_sample_sizes):
		for deg in range(num_degrees):
			for data_rep in range(num_data_replicates):
				with open("../output/case" + str(ERSAA_case_num[std]) + "_ersaa/mod_1/deg_" + str(deg+1) + "/rep_" + str(data_rep+1) + "/ols/samp_" + str(ERSAA_samp_num[std][samp_size]+1) + "/ersaa_obj.txt") as ERSAA_ols_file:
...
for std in range(num_stdevs):
	for samp_size in range(num_sample_sizes):
		for deg in range(num_degrees):
			for data_rep in range(num_data_replicates):
				with open("../output/case" + str(ERSAA_case_num[std]) + "_ersaa/mod_1/deg_" + str(deg+1) + "/rep_" + str(data_rep+1) + "/kNN/samp_" + str(ERSAA_samp_num[samp_size]+1) + "/ersaa_obj.txt") as ERSAA_knn_file:
...
for std in range(num_stdevs):
	for samp_size in range(num_sample_sizes):
		for deg in range(num_degrees):
			for data_rep in range(num_data_replicates):
				with open("../output/case" + str(BK_case_num[std]) + "_bk/mod_1/deg_" + str(deg+1) + "/rep_" + str(data_rep+1) + "/samp_" + str(BK_samp_num[samp_size]+1) + "/bk_obj.txt") as BK_file:
...
for std in range(num_stdevs):
	for samp_size in range(num_sample_sizes):
		for deg in range(num_degrees):
			for data_rep in range(num_data_replicates):
				with open("../output/case" + str(PP_case_num[std]) + "_pointpred/mod_1/deg_" + str(deg+1) + "/rep_" + str(data_rep+1) + "/ols/samp_" + str(PP_samp_num[samp_size]+1) + "/pointpred_obj.txt") as PP_ols_file:
